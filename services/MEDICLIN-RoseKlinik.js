...
let MEDICLIN_RoseKlinik = async (cluster,page,positions,levels) => {
  try {
    ...
    await page.goto("https://arbeiten-bei-mediclin.de/rose-klinik/offene-stellen/", {
      waitUntil: "load",
      timeout: 0,
    });
...
export default MEDICLIN_RoseKlinik;
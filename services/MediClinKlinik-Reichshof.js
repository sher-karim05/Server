...
let MediClinKlinik_Reichshof = async (cluster,page,positions,levels) => {
  try {
    ...
    await page.goto("https://arbeiten-bei-mediclin.de/klinik-reichshof/offene-stellen/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MediClin Klinik Reichshof",
          link: "",
          level: "",
          position: "",
...
export default MediClinKlinik_Reichshof;
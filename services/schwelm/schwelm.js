...
let schwelm = async (cluster,page,positions,levels) => {
  try {
   
    await page.goto(
      "https://www.helios-gesundheit.de/kliniken/schwelm/unser-haus/stellenangebote/",
      {
        waitUntil: "load",
        timeout: 0,
      }
    ...
    let nextPage = true;
    let allJobLinks = [];    //scroll the page
      await scroll(page);
      //get all jobLinks

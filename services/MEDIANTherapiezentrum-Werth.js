...
let MEDIANTherapiezentrum_Werth = async (cluster,page,positions,levels) => {
  try {

    await page.goto("https://www.median-kliniken.de/de/karriere/stellenangebote-bewerbung/stellenangebote.html?filter%5Bcountr%5D=Duisburg", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MEDIAN Therapiezentrum Haus Werth",
          link: "",
          level: "",
          position: "",
          city: "Duisburg",
...
export default MEDIANTherapiezentrum_Werth;
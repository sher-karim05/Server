...
let MediClinFachklinik_RheinRuhr = async (cluster,page,positions,levels) => {
  try {

    await page.goto("https://arbeiten-bei-mediclin.de/fachklinik-rheinruhr/offene-stellen/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "Essen",
          hospital: "MediClin Fachklinik Rhein/Ruhr",
          link: "",
          level: "",
          position: "",
          city: "Essen",
...
export default MediClinFachklinik_RheinRuhr;
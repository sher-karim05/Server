...
let MEDIANKlinik_Dormagen = async (cluster,page,positions,levels) => {
  try {

    await page.goto("https://www.median-kliniken.de/de/karriere/stellenangebote-bewerbung/stellenangebote.html?filter%5Bcountr%5D=Dormagen", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MEDIAN Klinik Dormagen",
          link: "",
          level: "",
          position: "",
          city: "Dormagen",
...
export default MEDIANKlinik_Dormagen;
...
let MEDIANKlinikBurggraben_BadSalzuflen = async (cluster,page,positions,levels) => {
  try {
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MEDIAN Klinik am Burggraben Bad Salzuflen",
          link: "",
          level: "",
          position: "",
          city: "Bad Salzuflen",
...
export default MEDIANKlinikBurggraben_BadSalzuflen;
...
let MEDIANTherapiezentrum_Loherhof = async (cluster,page,positions,levels) => {
  try {

    await page.goto("https://www.median-kliniken.de/de/karriere/stellenangebote-bewerbung/stellenangebote.html?filter%5Bcountr%5D=Geilenkirchen", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MEDIAN Therapiezentrum Loherhof",
          link: "",
          level: "",
          position: "",
          city: "LGeilenkirchen",
...
export default MEDIANTherapiezentrum_Loherhof
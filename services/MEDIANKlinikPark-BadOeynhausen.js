...
let MEDIANKlinikPark_BadOeynhausen = async (cluster,page,positions,levels) => {
  try {

    await page.goto("https://www.median-kliniken.de/de/karriere/stellenangebote-bewerbung/stellenangebote.html?filter%5Bcountr%5D=Bad%20Oeynhausen", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MEDIAN Klinik am Park Bad Oeynhausen",
          link: "",
          level: "",
          position: "",
          city: "Bad Oeynhausen",
...
export default MEDIANKlinikPark_BadOeynhausen;
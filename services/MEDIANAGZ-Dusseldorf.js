...
let MEDIANAGZ_Dusseldorf = async (cluster,page,positions,levels) => {
  try {

    await page.goto("https://www.median-kliniken.de/de/karriere/stellenangebote-bewerbung/stellenangebote.html?filter%5Bcountr%5D=D%C3%BCsseldorf", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      cluster.queue(async ({ page }) => {
        let job = {
          title: "",
          location: "",
          hospital: "MEDIAN AGZ Düsseldorf",
          link: "",
          level: "",
          position: "",
          city: "Düsseldorf",
...
export default  MEDIANAGZ_Dusseldorf;